...
export default function Header(props){
    ...
    return(
        <div className="header">
                ...
                <div className="loginDiv"> {isConnected? <Link to="/logout"><button className="loginBTN" onClick={handleLogout()}>Logout</button></Link> : <Link to="/login"><button className="loginBTN" onClick={handleConnection()}>Login</button></Link>}</div>
