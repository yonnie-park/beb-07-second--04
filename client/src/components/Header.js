...
export default function Header(){
    ...
    const handleLogout = async() =>{
        ...
        .then(()=>{
            setAccount({user_id: "", user_password: "", isConnected: false})
        })
    }
    return(
        <div className="header">
                ...
                <div className="signupDiv"><Link to="/login"><button className="loginBTN">Login</button></Link><Link to="/signup"><button className="joinBTN">Sign up</button></Link></div>}
        </div>
    )
}